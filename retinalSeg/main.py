...
# Define flags
flags = tf.app.flags
flags.DEFINE_integer("epoch", 30, "Number of training epochs (default: 300)")
...
flags.DEFINE_integer("number_train_images", 90, "No. of labeled images for training")
flags.DEFINE_integer("number_train_unlab_images", 390, "No. of unlabeled images for training")
flags.DEFINE_integer("number_test_images", 23, "No. of images for testing")

flags.DEFINE_string("data_directory", "../data1/Original", "Directory name containing the dataset")
...
flags.DEFINE_integer("num_mod", 3, "Number of modalities of the input 3-D image")
